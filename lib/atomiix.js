...
export default {
  ...
  activate() {
    ...
    this.inSocket = setupOSCListener(
      this.atomiixState, this.editorState, this.outSocket
    );
    ...
    sendMessages(this.outSocket, [setupOSCMessage(projectPath)]);
  },
  ...
  interpret() {
    ...
    sendMessages(this.outSocket, atomiix.actionToOSC(actions.audio));
...
function setupOSCListener(state, editorState, outSocket) {
